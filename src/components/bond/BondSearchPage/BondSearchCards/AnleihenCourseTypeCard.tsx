...
function FundVolumeCardContentView(props: CriteriaState<FundVolumeCardState>)  {
    ...
    return (
        <>
            ...
            />
            <span className="mx-1" style={{marginTop: "-2px"}}>mit Kurstyp</span>
...
const ANLEIHEN_RENDITE_OPTIONS: (OptionItem & {value: number})[] = [
    {id: "0", name: 'pari', value: 0},
    {id: "1", name: 'über pari', value: 1},
    {id: "2", name: 'unter pari', value: 2},
];

export const AnleihenCourseTypeCard = wrapBondSearchCard(
