...
function FundVolumeCardContentView(props: CriteriaState<FundVolumeCardState>)  {
    ...
    return (
        <>
            ...
            />
            <span className="mx-1" style={{marginTop: "-2px"}}>mit Inflationsschutz</span>
...
const ANLEIHEN_RENDITE_OPTIONS: (OptionItem & {value: number})[] = [
    {id: "0", name: 'ja', value: 0},
    {id: "1", name: 'nein', value: 1},
];

export const AnleihenInflationCard = wrapBondSearchCard(
