...
export default function AktienanleiheCharacteristics({group}: WarrantCharacteristicsContainerProps) {
    ...
    const FullItems: Array<keyFigureType> = [
        ...
        },
        {
            id: 8,
            name: 'Bezugsmenge',
            value: getUnderlyingValue(group?.underlyings, 'multiplier')
        },
        {
            id: 9,
            name: 'SW Ertrag abs',
