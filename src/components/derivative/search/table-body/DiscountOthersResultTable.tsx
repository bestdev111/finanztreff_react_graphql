...
import {discountTypMapping} from "./common/DerivativeTypeMapping";
...
export const DiscountOthersResultTable = ({group, loading, wkn, dueTo, typeNameValue, ask, bid, id, assetTypeValue, performance}: DerivativeResultTableProps) => {
    ...
    return(
        <>
            <tr className="border-bottom border-border-gray">
                ...
                <td className={"d-md-table-cell d-none"}>{discountTypMapping(typeNameValue?.name)}</td>
                <td><td className={"d-md-table-cell d-none text-right"}>{getPerformance(performance, CalculationPeriod.Month1)}</td></td>
...
export default DiscountOthersResultTable
