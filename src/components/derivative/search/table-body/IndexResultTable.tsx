...
export const IndexResultTable = ({group, performance, loading, wkn, ask, bid, id, typeNameValue, dueTo, assetTypeValue}: DerivativeResultTableProps) => {
...
export default IndexResultTable
