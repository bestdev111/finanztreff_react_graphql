...
interface DiscountCapFilterProps extends React.HTMLAttributes<HTMLDivElement> {
...
export function DiscountCapFilter({
                              currentFilter,
                              showButton,
                              showContent,
                              contentActive,
        ...
        <>
            {
                ...
                <Dropdown show={show && isDesktop} className={className}>
                    <DropdownButton text="Cap" subText={subText()} onClick={() => {
                        if (onClick) onClick();
                        setShow(!show)
                    ...
                    <Dropdown.Menu className="p-2 dropdown-menu-content d-md-block d-none" style={{width: 330}}>
                        <DropdownMenuHeader title="Cap" close={() => cancelFilter()}/>
                        {content}
                ...
                <CSSTransition timeout={250}
                    ...
                    <div className={"container carusel-modal-right"} onClick={(event) => {
                        ...
                        <div className="d-flex justify-content-between bg-white py-3 pl-3">
                            <span className="font-weight-bold roboto-heading">Cap</span>
