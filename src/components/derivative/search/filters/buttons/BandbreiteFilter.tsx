...
interface BandbreiteFilterProps extends React.HTMLAttributes<HTMLDivElement> {
...
export function BandbreiteFilter({
                              currentFilter,
                              showButton,
                              showContent,
                              contentActive,
    ...
    const subText = function () {
        ...
        let capPriseText: string = von + bis;
    ...
    const content = (
        <>
            <div className="bg-white d-block">
                <VonBisBasePeriod title={''} currentFilter={currentFilter.cap} withBase={false}
        ...
        <>
            {
                ...
                <Dropdown show={show && isDesktop} className={className}>
                    <DropdownButton text="Bandbreite" subText={subText()} onClick={() => {
                        if (onClick) onClick();
                        setShow(!show)
                    ...
                    <Dropdown.Menu className="p-2 dropdown-menu-content d-md-block d-none" style={{width: 330}}>
                        <DropdownMenuHeader title="Bandbreite" close={() => cancelFilter()}/>
                        {content}
                ...
                <CSSTransition timeout={250}
                    ...
                    <div className={"container carusel-modal-right"} onClick={(event) => {
                        ...
                        <div className="d-flex justify-content-between bg-white py-3 pl-3">
                            <span className="font-weight-bold roboto-heading">Bandbreite</span>
