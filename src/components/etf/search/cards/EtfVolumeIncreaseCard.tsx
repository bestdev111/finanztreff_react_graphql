...
interface EtfVolumeIncreaseCardProps extends BaseEtfSearchProps {
    children?: ReactNode;
}

interface EtfVolumeIncreaseCardState extends GlobalEtfSearchProps {
    value: number;
    valueId: string;
}

function EtfVolumeIncreaseCardContentView(props: CriteriaState<EtfVolumeIncreaseCardState>)  {
    ...
    return (
        <>
            ...
            <span className="mx-1" style={{marginTop: "-2px"}}>steigenden Fondsvolumen innerhalb</span>
...
function renderQuery(state: EtfVolumeIncreaseCardState, metadata: EtfSearchContextProps | null): SearchEtfCriterion {
...
export const EtfVolumeIncreaseCard = wrapEtfSearchCard(
    generateEtfCard<EtfVolumeIncreaseCardProps & EnabledProps, EtfVolumeIncreaseCardState>(
        EtfVolumeIncreaseCardContentView
    ),
    renderQuery,
