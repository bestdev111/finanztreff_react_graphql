...
function EtfSmallerPerformanceCardContentView(props: CriteriaState<EtfSmallerPerformanceCardState>)  {
    ...
    return (
        <>
            ...
            <span className="mx-1" style={{marginTop: "-2px"}}>Performance kleiner аls</span>
...
function renderQuery(state: EtfSmallerPerformanceCardState, metadata: EtfSearchContextProps | null): SearchEtfCriterion {
...
export const EtfSmallerPerformanceCard = wrapEtfSearchCard(
