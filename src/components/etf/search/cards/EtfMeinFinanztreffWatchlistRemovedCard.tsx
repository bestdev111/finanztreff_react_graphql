...
interface EtfMeinFinanztreffWatchlistRemovedCardProps extends BaseEtfSearchProps {
    children?: ReactNode;
}

interface EtfMeinFinanztreffWatchlistRemovedCardState extends GlobalEtfSearchProps {
    value: number | undefined;
    valueId: string;
}

function EtfMeinFinanztreffWatchlistRemovedCardContentView(props: CriteriaState<EtfMeinFinanztreffWatchlistRemovedCardState>)  {
...
function renderQuery(state: EtfMeinFinanztreffWatchlistRemovedCardState, metadata: EtfSearchContextProps | null): SearchEtfCriterion {
...
export const EtfMeinFinanztreffWatchlistRemovedCard = wrapEtfSearchCard(
    generateEtfCard<EtfMeinFinanztreffWatchlistRemovedCardProps & EnabledProps, EtfMeinFinanztreffWatchlistRemovedCardState>(
        EtfMeinFinanztreffWatchlistRemovedCardContentView
    ),
    renderQuery,
