...
function EtfGreaterKeyfigureDistanceCardContentView(props: CriteriaState<EtfGreaterPerformanceCardState>)  {
    ...
    return (
        <>
            ...
            <span className="mx-1" style={{marginTop: "-2px"}}>größer als</span>
            <FilterDropdownItem<OptionItem & {value: number}>
...
export const EtfGreaterKeyfigureDistanceCard = wrapEtfSearchCard(
    generateEtfCard<EtfGreaterPerformanceCardProps & EnabledProps, EtfGreaterPerformanceCardState>(
        EtfGreaterKeyfigureDistanceCardContentView
    ),
    renderQuery,
