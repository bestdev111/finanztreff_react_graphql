...
interface EtfMeinFinanztreffPortfolioAddedCardProps extends BaseEtfSearchProps {
    children?: ReactNode;
}

interface EtfMeinFinanztreffPortfolioAddedCardState extends GlobalEtfSearchProps {
    value: number | undefined;
    valueId: string;
}

function EtfMeinFinanztreffPortfolioAddedCardContentView(props: CriteriaState<EtfMeinFinanztreffPortfolioAddedCardState>)  {
...
function renderQuery(state: EtfMeinFinanztreffPortfolioAddedCardState, metadata: EtfSearchContextProps | null): SearchEtfCriterion {
...
export const EtfMeinFinanztreffPortfolioAddedCard = wrapEtfSearchCard(
    generateEtfCard<EtfMeinFinanztreffPortfolioAddedCardProps & EnabledProps, EtfMeinFinanztreffPortfolioAddedCardState>(
        EtfMeinFinanztreffPortfolioAddedCardContentView
    ),
    renderQuery,
