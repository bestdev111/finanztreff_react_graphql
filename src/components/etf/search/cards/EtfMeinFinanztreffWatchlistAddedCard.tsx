...
interface EtfMeinFinanztreffWatchlistAddedCardProps extends BaseEtfSearchProps {
    children?: ReactNode;
}

interface EtfMeinFinanztreffWatchlistAddedCardState extends GlobalEtfSearchProps {
    value: number | undefined;
    valueId: string;
}

function EtfMeinFinanztreffWatchlistAddedCardContentView(props: CriteriaState<EtfMeinFinanztreffWatchlistAddedCardState>)  {
    ...
    return (
        <>
            ...
            <span className="mx-1" style={{marginTop: "-2px"}}>aufgenommen wurden</span>
        </>
    )
}
...
function renderQuery(state: EtfMeinFinanztreffWatchlistAddedCardState, metadata: EtfSearchContextProps | null): SearchEtfCriterion {
...
export const EtfMeinFinanztreffWatchlistAddedCard = wrapEtfSearchCard(
    generateEtfCard<EtfMeinFinanztreffWatchlistAddedCardProps & EnabledProps, EtfMeinFinanztreffWatchlistAddedCardState>(
        EtfMeinFinanztreffWatchlistAddedCardContentView
    ),
    renderQuery,
