...
interface FundPerformanceSavingSearchCardProps extends BaseFundSearchProps {
    children?: ReactNode;
}
...
interface FundPerformanceSavingSearchCardState extends GlobalFundSearchProps {
    value: number;
}

function FundPerformanceSavingSearchCardView({state, setCriteria}: CriteriaState<FundPerformanceSavingSearchCardState>) {
    ...
    return (
        <>
            ...
            <span className="mx-1" style={{ marginTop: "-2px" }}>
                welche Vermögenswirksame Leistung fähig sind und eine Performance von mind.
            </span>
            <FilterDropdownItem<OptionItem>
                options={PERCENTAGE}
                onSelect={(value: OptionItem) => { }}
...
function renderQuery(state: FundPerformanceSavingSearchCardState, metadata: FundsSearchContextProps | null): SearchFundCriterion {
    return {
...
export const FundPerformanceSavingSearchCard = wrapFundSearchCard<FundPerformanceSavingSearchCardState>(
    generateFundCard<FundPerformanceSavingSearchCardProps & EnabledProps, FundPerformanceSavingSearchCardState>(
        FundPerformanceSavingSearchCardView,
    ),
    renderQuery,
    {typeId: null, topicId: null, strategyId: null, regionId: null, currencyId: null, value: 1},
    true,
    "VL-Sparen"
);
